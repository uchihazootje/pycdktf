...
class MySimpleStack(TerraformStack):
    def __init__(self, scope: Construct, id: str):
        ...
        self._storage_backend_settings: TerraformAzureStorageBackendSetting = TerraformAzureStorageBackendSetting(state_file_name=f"{self._id}-mysimplestack")
        ...
        self._simple_stack_rg: ResourceGroup = ResourceGroup(
            ...
            id_="MySimpleStackResourceGroup",
            name="mysimplestack-rg",
        ...
        self._storage_account = StorageAccount(
            scope=self,
            provider=self._azure_provider,
            id_="MyStorageAccount",
            name="myrsimplestackadls",
        ...
        self._storage_container = StorageDataLakeGen2Filesystem(
            scope=self,
            provider=self._azure_provider,
            id_=f"MyStorageContainer",
            name="myrssimplecontainer",
        ...
        # Add storager account as a linked service to azure data factory
        DataFactoryLinkedServiceAzureBlobStorage(
            scope=self,
            id_="MyDataFactoryLinkedService",
            provider=self._azure_provider,
